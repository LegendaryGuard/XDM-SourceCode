...
#define SF_DOOR_FORCETOUCHABLE		1024// XDM3037: can have targetname and still react on touch
#define SF_DOOR_SILENT				0x80000000

// m_bDontDraw flags
#define DOOR_DRAW_ALWAYS			0
#define	DOOR_NODRAW_OPEN			1
#define DOOR_NODRAW_CLOSED			2
...
#define DOOR_VSOUND_VOLUME			192// XDM3038c: virtual sound for the AI
...
public:
	...
	virtual bool HasTarget(string_t targetname);// XDM3037
	...
	virtual bool IsRotating(void) const { return false; }// XDM
...
public:
	virtual void Spawn(void);
	virtual void SetToggleState(int state);
	virtual bool IsRotating(void) const { return true; }// XDM
};
