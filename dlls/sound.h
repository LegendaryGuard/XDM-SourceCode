...
public:
	...
	EHANDLE m_hPlayFrom;// XDM3038c: entity to play sound from
	int m_iChannel;// SHL: the channel to play from, for "play from X" sounds
};

#define SF_ENVSOUND_PERSISTENT		1
...
#define ANNOUNCE_MINUTES_MAX	1.5
...
public:
	...
	float m_flAttenuation;// XDM3037a: attenuation value
	int m_iPitch;// XDM3037a
	int m_iDelayMin;// XDM3037a: next announcement time
	int m_iDelayMax;
};
