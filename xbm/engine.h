...
// Proxy API
// Each of these functions is made to intercept and forward calls from MOD DLL to the engine
...
int pfnCheckParm(const char *pchCmdLineToken, char **ppnext);// HL20130901
