...
#define GAITSEQUENCE_DISABLED		255// XDM3037: it is transmitted as a unsigned byte, so we can't use -1, but we have to allow 0
...
typedef enum activity_e
{
	...
	ACT_CROUCH,				// the act of crouching down from a standing position // XDM3037: WRONG! For players this means moving while crouching! (FL_DUCKING)
