...
// XDM: universal types for online selection // void *?
typedef byte *texture_t;
typedef byte *mnode_t;
typedef byte *mleaf_t;
typedef byte *msurface_t;
...
//
// XDM3037: sprite data structures
//
...
typedef enum spriterendermode_e
{
	SPR_NORMAL = 0,
	SPR_ADDITIVE,
	SPR_INDEXALPHA,
	SPR_ALPHTEST// yes, that's a valve's typo
} spriterendermode_t;
...
{
	short	type;// spritetype_t
	short	texFormat;// spriterendermode_t
	int		maxwidth;
	int		maxheight;
	int		numframes;
	int		radius;
